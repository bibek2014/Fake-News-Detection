...
def Train_Model(Path):
    ...
    filename = 'Model1_LogisticRegression_Title.sav'
    ...
    with open('Model1_LogisticRegression_Report_Title.json', 'w', encoding='utf-8') as f:
...
def Predict(q):
    ...
    filename = path+'/Model1_LogisticRegression_Title.sav'
    print(filename)
    ...
    # Opening JSON file
    f = open(path+'/Model1_LogisticRegression_Report_Title.json') 
    report = json.load(f)
...
if __name__ == "__main__":
    ...
    # Opening JSON file
    f = open('Model1_LogisticRegression_Report_Title.json') 
    report = json.load(f)
