...
def Train_Model(Path):
    ...
    filename = 'Model2_DecisionTreeClassifier.sav'
    ...
    with open('Model2_DecisionTreeClassifier_Report.json', 'w', encoding='utf-8') as f:
...
def Predict(q):
    ...
    filename = path+'/Model2_DecisionTreeClassifier.sav'
    print(filename)
    ...
    # Opening JSON file
    f = open(path+'/Model2_DecisionTreeClassifier_Report.json') 
    report = json.load(f)
...
if __name__ == "__main__":
    ...
    # Opening JSON file
    f = open('Model2_DecisionTreeClassifier_Report.json') 
    report = json.load(f)
