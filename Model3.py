...
def Train_Model(Path):
    ...
    with open('Model3_GBC_Report.json', 'w', encoding='utf-8') as f:
...
def Predict(q):
    ...
    # Opening JSON file
    f = open(path+'/Model3_GBC_Report.json') 
    report = json.load(f)
