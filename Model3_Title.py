...
def Train_Model(Path):
    ...
    with open('Model3_GBC_Report_Title.json', 'w', encoding='utf-8') as f:
...
def Predict(q):
    ...
    filename = path+'/Model3_GBC_Title.sav'
    print(filename)
    ...
    # Opening JSON file
    f = open(path+'/Model3_GBC_Report_Title.json') 
    report = json.load(f)
    ...
    report["Model"]="Gradient Boosting Classifier "
    return report	
...
if __name__ == "__main__":
    ...
    # Opening JSON file
    f = open('Model3_GBC_Report_Title.json') 
    report = json.load(f)
